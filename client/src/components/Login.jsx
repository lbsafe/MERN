...
const Login = ()=>{
    ...
    const passwordToggleButton = (
        <button
            type="button"
            className="absolute right-0 h-full px-3 py-2 text-sm font-semibold"
    ...
    return (
        <form onSubmit={handleSubmit} className="max-w-xs p-4 mt-16 mx-auto">
            ...
            <div className="mt-4 mb-4 flex justify-center">
                <img src="/logo.png" alt="Instagram" className="w-36" />
            </div>

            {/* 이메일 입력란 */}
            <div className="mb-2">
                <label className="block rounded focus-within:outline">
                    <input
                        type="text"
            ...
            {/* 비밀번호 입력란 */}
            <div className="mb-2">
                <label className="block relative border rounded focus-within:outline">
                    <input
                        type={showPassword ? "text" : "password"}
                        className="px-2 py-1 w-full max-w-44 text-ellipsis overflow-hidden rounded focus:outline-none"
                        value={password}
                        placeholder="비밀번호"
